    ...
    public ResultadoVoid eliminarTodosLosDatos() {
        ...
        try {
            ...
            result.agregarError(new RuntimeException(
                    "Ocurrió un error al eliminar la información local! Es probable que la " +
                            "información se haya corrompido, porfavor elimine los datos desde el " +
