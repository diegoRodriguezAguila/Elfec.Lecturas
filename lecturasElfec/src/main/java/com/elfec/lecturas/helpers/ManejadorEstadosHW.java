...
/**
 * Se encarga de verifica y cambiar los estados de los dispositivos de HW como
 * los datos moviles, el GPS y la bateria
 * 
 * @author drodriguez
 *
 */
public class ManejadorEstadosHW {
	...
	/**
	 * Verifica el estado del servicio de ubicacion de GPS, verifica que la
	 * opcion este activada o no, no verifica conectividad ni ningun otro tipo
	 * de estado.
	 * 
	 * @param context
	 * @return
	...
	public static boolean servicioGPSEstaDeshabilitado(Context context) {
		return !Settings.Secure.getString(context.getContentResolver(),
				Settings.Secure.LOCATION_PROVIDERS_ALLOWED).contains("gps");
	}

	/**
	 * Verifica el estado de los datos 3g y si estan desactivados retorna true,
	 * cualquier otro estado es false, haya conexiona internet o no, solo
	 * verifica que la opcion este o no activada.
	 * 
	 * @param context
	 * @return
	 */
	...
	/**
	 * Verifica si la bateria esta por debajo del nivel critico establecido en
	 * las VariablesDeEntorno
	 * 
	 * @param context
