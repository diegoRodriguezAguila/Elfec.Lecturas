...
import com.lecturas.elfec.modelo.validaciones.ErrorUsuarioPasswordIncorrectos;

/**
 * Define el paso de validación de usuario en el que se intenta obtener al usuario de la base de datos Oracle.
 * <br><br><b>Código: PVU-1.1</b>
 * @author drodriguez
 *
 */
public class PasoObtenerUsuarioOracle extends PasoValidacionUsuario {
	 ...
	 * <b>FlujoPasosValidacionUsuario.usuarioEncontrado</b>. Si existe un error de conexión retorna null y el resultado
