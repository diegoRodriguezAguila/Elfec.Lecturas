...
/**
 * Almacena la información sobre las bases de calculo, de la tabla ERP_ELFEC.GBASES_CALC de la BD ERP_ELFEC de Oracle
 * @author drodriguez
 */
...
public class BaseCalculo extends Model {
	...
	/**
	 * Accede a la base de datos y obtiene la base de calculo correspodiente al ID proporcionado
	 * @param idBaseCalculo
	...
	{
		return new Select()
        .from(BaseCalculo.class).where("IDBASE_CALCULO="+idBaseCalculo)
        .executeSingle();
	}
