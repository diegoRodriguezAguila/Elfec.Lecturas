...
/**
 * Almacena la información sobre las categorias de conceptos, de la tabla ERP_ELFEC.CONCEPTOS_TARIFAS de la BD Oracle
 * @author drodriguez
 */
...
public class ConceptoTarifa extends Model {
	...
	/**
	 * Accede a la base de datos y obtiene todos los concepto tarifas por aplicabilidad
	 * @param aplicabilidad
	 * @return Lista de ConceptoTarifas en orden de ORDEN_CALCULO
	 */
	public static List<ConceptoTarifa> obtenerConceptoTarifasPorAplicabilidad(String aplicabilidad)
	{
		return new Select()
        .from(ConceptoTarifa.class).where("APLICABILIDAD='"+aplicabilidad+"'")
        		.orderBy("ORDEN_CALCULO")
        .execute();
	}
