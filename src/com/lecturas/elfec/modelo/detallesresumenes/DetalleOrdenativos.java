...
public class DetalleOrdenativos extends DetalleResumenGenerico{
	...
	{
		titulo="DETALLE LECTURAS ORDENATIVOS";
	...
	/**
	 * Obtiene los resumenes de lecturas que tengan los ordenativos de los parametros en <b>VariablesDeEntorno</b> para este Resumen
	 * @return Lista de tipo <b>ResumenLectura</b> con resumenes de las lecturas que cumplen las condiciones
	 */
	@Override
	public List<ResumenLectura> obtenerResumenesLecturas()
	{
		List<ResumenLectura> resLecs = new ArrayList<ResumenLectura>();
		List<OrdenativoLectura> ordLecs = OrdenativoLectura.obtenerLecturasConOrdenativosParametros();
		for (OrdenativoLectura ordLectura : ordLecs) 
		{
			...
			{
				List<OrdenativoLectura> ordenativos = ordLectura.Lectura.obtenerOrdenativosLectura();
