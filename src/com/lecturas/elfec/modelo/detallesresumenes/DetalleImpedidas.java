...
public class DetalleImpedidas extends DetalleResumenGenerico {
	...
	{
		titulo="DETALLE LECTURAS IMPEDIDAS";
	...
	public List<ResumenLectura> obtenerResumenesLecturas() {
		ArrayList<Lectura> lecturas = (ArrayList<Lectura>) Lectura.obtenerLecturasPorEstado(2);//impedidas
		...
		for (Lectura lec : lecturas) 
		{
			...
			List<OrdenativoLectura> ordenativos = lec.obtenerOrdenativosLectura();
