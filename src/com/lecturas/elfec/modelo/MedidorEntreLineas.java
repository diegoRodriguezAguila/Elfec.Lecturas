...
public class MedidorEntreLineas extends Model implements EventoAlObtenerUbicacion, EventoAlObtenerResultado, IModeloBackupableTexto
{
	...
	/**
	 * Cuando fue enviado por 3g tiene el estado 1, 0 en caso contrario, 2 en caso de haberse enviado
	 * por otro medio al servidor.
	 */
	...
	public MedidorEntreLineas(String numMedidor, int ruta, int lecturaNueva, BigDecimal lecturaPotencia,  BigDecimal energiaReactiva, Date fecha) 
	{
		super();
	...
	/**
	 * Accede a la base de datos y obtiene todas las lecturas de medidores entre lineas
	 * @return Lista de medidores entre lineas
	 */
	public static List<MedidorEntreLineas> obtenerMedidoresEntreLineas()
	{
		return new Select()
        .from(MedidorEntreLineas.class)
        .execute();
	}
	
	/**
	 * Accede a la base de datos y obtiene todas las lecturas de medidores entre lineas, que tienen el atributo Enviado3G=0
	...
	{
		return new Select()
        .from(MedidorEntreLineas.class).where("Enviado3G=0")
        .execute();
	}
	...
	public String obtenerLineaTextoBackup() 
	{
		...
		String fechaHora = df.format(this.FechaLectura)+" "+this.HoraLectura;
		StringBuilder str = new StringBuilder("");
		str.append(Ruta).append("|").append(NumeroMedidor).append("|").append(LecturaNueva).append("|")
		.append(Reactiva!=null?Reactiva:"-").append("|").append(LecturaPotencia!=null?LecturaPotencia:"-").append("|")
