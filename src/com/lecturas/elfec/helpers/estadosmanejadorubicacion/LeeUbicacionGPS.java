...
public class LeeUbicacionGPS implements IEstadoManejadorUbicacion {
	...
	static
	{
		EstadoManejadorUbicacionFactory.registrarEstado(2,new LeeUbicacionGPS());
	}
	
	private LeeUbicacionGPS()
	{
	...
	{
		this.manejadorUbicacion = (LocationManager) context.getSystemService(Context.LOCATION_SERVICE);
	}
	...
	public boolean proveedorEstaHabilitado() {
		...
		try{gps_habilitado=manejadorUbicacion.isProviderEnabled(LocationManager.GPS_PROVIDER);}catch(Exception ex){}
	...
	public void obtenerUbicacion(LocationListener locationListener) {	
		...
		manejadorUbicacion.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, locationListener);
	}
