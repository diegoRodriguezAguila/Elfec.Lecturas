...
import com.lecturas.elfec.controlador.BuscarLectura;
...
public class DialogoResultadosBusqueda extends CustomDialog {
	...
	public DialogoResultadosBusqueda(BuscarLectura context, List<Lectura> listaResultadosLecs) {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) 
    {
		...
		LecturaAdapter adapter = new LecturaAdapter(context, R.layout.list_item_lectura,listaLecturas, true); // the adapter is a member field in the activity
