...
public class ListaLecturas extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listViewLecturas.setOnItemClickListener(new LecturaItemClickListener(
				this));
		listaLecturas = Lectura.obtenerTodasLasLecturas();
				...
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> parentView,
						...
						if (position == 0)// Todas
						{
							...
							listaLecturas = (ArrayList<Lectura>) Lectura
									.obtenerLecturasPorEstado(position - 1);
						}
						asignarDatos();
					}
	...
	public void asignarDatos() {
		adapter = new LecturaAdapter(this, R.layout.list_item_lectura,
				listaLecturas); // the adapter is a member field in the activity
